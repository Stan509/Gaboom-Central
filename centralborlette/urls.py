...
urlpatterns = [
    ...
    path('superadmin/borlette/<int:borlette_id>/delete/', accounts_views.superadmin_delete_borlette, name='superadmin_delete_borlette'),
    path('superadmin/borlette/<int:borlette_id>/toggle-vip/', accounts_views.superadmin_toggle_borlette_vip, name='superadmin_toggle_borlette_vip'),
    path('superadmin/borlette/<int:borlette_id>/toggle-lifetime/', accounts_views.superadmin_toggle_borlette_lifetime, name='superadmin_toggle_borlette_lifetime'),
    path('superadmin/profits/reset/', accounts_views.superadmin_reset_profit_counter, name='superadmin_reset_profit_counter'),
