...
def _get_borlette_logo_url(request: HttpRequest, borlette: Borlette) -> str:
    ...
    try:
        return request.build_absolute_uri(reverse("borlette_logo", kwargs={"borlette_id": borlette.id}))
    except Exception:
        return borlette.logo_url or ""
...
def api_login(request: HttpRequest) -> JsonResponse:
    ...
    return _json_success({
        ...
        "borlette": {
            ...
            "logo_url": _get_borlette_logo_url(request, agent.borlette),
...
def api_ticket_print(request: HttpRequest, ticket_id: str) -> JsonResponse:
    ...
    logo_url = _get_borlette_logo_url(request, borlette)
...
def api_ticket_list_agent(request: HttpRequest) -> JsonResponse:
    ...
    for ticket in qs:
        ...
        tickets_data.append({
            ...
            "can_pay": ticket.is_winner and not ticket.is_paid and ticket.statut != TicketStatus.ANNULE,
            "can_void": can_void,
